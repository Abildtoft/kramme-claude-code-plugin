...
| `/kramme:granola-meeting-notes` | Query meeting notes from Granola (macOS, Windows untested). Supports fuzzy search, pattern analysis, transcript stats, and markdown export. |
...
| `kramme:granola-meeting-notes` | Query Granola meetings (macOS, Windows untested) with fuzzy search, pattern analysis, transcript stats, and export. Triggers on "meetings", "who do I meet with", "meeting patterns" |
