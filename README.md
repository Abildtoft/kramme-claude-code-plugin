...
| `/kramme:granola-meeting-notes` | Query meeting notes from Granola (macOS/Windows). Supports fuzzy search, pattern analysis, transcript stats, and markdown export. |
...
| `kramme:granola-meeting-notes` | Query Granola meetings (macOS/Windows) with fuzzy search, pattern analysis, transcript stats, and export. Triggers on "meetings", "who do I meet with", "meeting patterns" |
